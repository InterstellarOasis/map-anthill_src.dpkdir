textures/anthill_b2a/misc_skybox
{
	qer_editorimage textures/anthill_b2a/sky1.tga
	qer_trans 0.5
	...
	q3map_lightImage map textures/anthill_b2a/sky1.tga
	...
	// skyparms env/anthill_b2a/farbox 256 env/anthill_b2a/nearbox
	skyparms env/anthill_b2a/skybox - -
	// skyparms - 256 -

	// {
	// 	map textures/anthill_b2a/sky1.tga
	...
	// }
	// {
	// 	map textures/anthill_b2a/sky0.tga
...
textures/anthill_b2a/misc_sky_ns
{
	qer_editorimage textures/anthill_b2a/sky1.tga
	qer_trans 0.5
...
textures/anthill_b2a/misc_lava
{
	...
	{
		map textures/anthill_b2a/lava0.tga
		blendfunc add
		tcMod scale .05 .05
	...
	{
		map textures/anthill_b2a/lava1.tga
		tcMod scale .05 .05
		blendfunc add
	}
	//{
	//	map textures/anthill_b2a/lava2.tga
	//	blendfunc filter
